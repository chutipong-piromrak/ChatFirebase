...
import com.example.leomossi.chatfirebase.activity.LoginActivity;
...
public class SettingFragment extends Fragment {
    ...
    public void logOut() {
        ...
        builderLogOut.setPositiveButton("ใช่", new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                spotsDialog = new SpotsDialog(getActivity(), "กำลังออกจากระบบ");
                spotsDialog.show();
                ...
                getActivity().finish();
                Toast.makeText(getActivity(), "คุณได้ออกจากระบบ", Toast.LENGTH_SHORT).show();
                spotsDialog.dismiss();
            }
        });
    ...
    public void delAccount() {
        ...
        builder.setPositiveButton("ใช่", new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                spotsDialog = new SpotsDialog(getActivity(), "กำลังลบบัญชี");
                spotsDialog.show();
                        ...
                        .addOnCompleteListener(new OnCompleteListener<Void>() {
                            ...
                            public void onComplete(@NonNull Task<Void> task) {
                                if (task.isSuccessful()) {
                                    ...
                                    startActivity(intent);
                                    getActivity().finish();
                                    Toast.makeText(getActivity(), "ลบขัญชีสำเร็จ", Toast.LENGTH_SHORT).show();
